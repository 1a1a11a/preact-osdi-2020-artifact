...
HDFS_MASTER_NODE=node0
DFSPERF_MASTER_NODE=node21
USER=saukad
EXP=qv79471
PROJ=redundancy-pg0
...
export DFS_PERF_DFS_ADDRESS="hdfs://$HDFS_MASTER_NODE.$USER-$EXP.$PROJ.apt.emulab.net:9000"
...
DFS_PERF_MASTER_HOSTNAME="$DFSPERF_MASTER_NODE.$USER-$EXP.$PROJ.apt.emulab.net"
