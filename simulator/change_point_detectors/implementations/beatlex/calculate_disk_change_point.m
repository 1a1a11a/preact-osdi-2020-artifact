function [starts, ends, idx] = calculate_disk_change_point(X, outfile_path)
%clc; clearvars; close all;
%data_path = r'./data/seagate_4tb/seagate_4tb_3_month.csv';
%outfile_path = './plots/seagate_4tb_3_month_summarization.pdf';
addpath util;
addpath util/distinguishable_colors;
addpath util/subaxis;

%X = csvread('./data/seagate_4tb/seagate_4tb_3_month.csv')';
%X = csvread(data_path);
%X = data
...
%[Smin, Smax, maxdist] = tune_hyperparams(X)
...
%end
%linkaxes(sub,'x')
%printpdf(gcf, 'plots/seagate_4tb_3_month_summarization.pdf');
%printpdf(gcf, outfile_path);
